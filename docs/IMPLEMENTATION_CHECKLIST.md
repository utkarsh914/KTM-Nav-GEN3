...
- **P5–P6:** pending (polish incl. share-link fold-in + extracting a shared `PlaceSearch` composable to de-dup the settings picker; **docs update per NAVIGATION_UX_REVAMP.md §9**).
