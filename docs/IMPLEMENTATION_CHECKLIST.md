...
- **P3–P6:** pending (route preview + START; on-phone active guidance via `NavigationView` + END; polish incl. share-link fold-in + extracting a shared `PlaceSearch` composable to de-dup the settings picker; **docs update per NAVIGATION_UX_REVAMP.md §9**).
