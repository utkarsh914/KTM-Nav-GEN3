...
- **P2–P6:** pending (search sheet + recents/favorites; route preview + START; on-phone active guidance via `NavigationView` + END; polish; **docs update per NAVIGATION_UX_REVAMP.md §9**).
